...
<html>
    <head>
        ...
        <title>MATICS MEDIA CONTACT US</title>
    </head>
    <body>
        <div class="container">
            <div class="contact">
                ...
                <form action="contact.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="tel">Tel/mobile number * </label>
                            <input type="tel" name="tel" autocomplete="off" class="form-control" placeholder="Tel/mobile number"<?php echo isset ($fields['tel'])? 'value="'.e($fields['tel']).'"':''?>>
                    </div>
                    <div class="form-group" >
